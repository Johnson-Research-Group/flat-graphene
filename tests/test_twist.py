...
p_found, q_found, theta_comp = twist.find_p_q(21.79)
...
p_found, q_found, theta_comp = twist.find_p_q(21.79)
atoms = twist.make_graphene(cell_type='hex',n_layer=2,
                               p=p_found,q=q_found,lat_con=[a,1.01*a],
                               sep=3.35,h_vac=3)
ase.visualize.view(atoms)

#large, arbitrary 5 layer system with per-layer inputs
p_found, q_found, theta_comp = twist.find_p_q(9.43)
atoms = twist.make_graphene(cell_type='hex',n_layer=5,
                               p=p_found,q=q_found,lat_con=0.0,a_nn=1.5,
